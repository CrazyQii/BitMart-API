...
class APISpot(CloudClient):
    ...
    def post_custom_order(self, symbol: str, size='', price='', side=''):
        param = {
            'symbol': symbol,
            'taker': side,
            'size': size,
        ...
        return self._request_with_params(POST, API_SPOT_CUSTOM_ORDER_URL, param, Auth.SIGNED)
    ...
    def post_cancel_order(self, symbol: str, order_id: int):
        param = {
            'symbol': symbol,
            'order_id': order_id
        }
    ...
    def get_user_order_detail(self, symbol: str, order_id: int):
        param = {
            'symbol': symbol,
            'order_id': order_id
        }
    ...
    def get_user_order_trades(self, symbol: str, order_id: int):
        param = {
            'symbol': symbol,
            'order_id': order_id
        }
