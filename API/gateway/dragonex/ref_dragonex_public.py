...
class RefDragonexPublic(object):
    def __init__(self, urlbase):
        self.dragonex_public = DragonexPublic(urlbase)
    ...
    def get_price(self, symbol):
        try:
            ...
            price_base = float(self.dragonex_public.get_price(base_pair))
            price_quote = float(self.dragonex_public.get_price(quote_pair))
            if operator == 0:
...
if __name__ == "__main__":
    ref_dragonex_public = RefDragonexPublic("https://openapi.dragonex.io/api/v1/")
    # print ref_dragonex_public.get_price("ODE_BTC")
